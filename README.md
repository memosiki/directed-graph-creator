Курсовая работа по предмету "Дискретная математика"
======================
Курсовая работа, основанная на готовом инструменте для создания графов. Релизована работа с прадеревьями, пересчёт прадеревьев.
